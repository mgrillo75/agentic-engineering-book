...
- [Prompt Structuring](chapters/2-prompt/2-structuring.md)
...
- [Model Behavior](chapters/3-model/2-model-behavior.md)
- [Model Limitations and Workarounds](chapters/3-model/3-model-limitations.md)
- [Multi-Model Architectures](chapters/3-model/4-multi-model-architectures.md)
- [Model Evaluation for Agents](chapters/3-model/5-model-evaluation.md)
### Chapter 4: Context
...
- [Tool Selection and Routing](chapters/5-tool-use/2-tool-selection.md)
- [Tool Restrictions and Security](chapters/5-tool-use/3-tool-restrictions.md)
...
### Examples
- [gastown](appendices/examples/gastown)
- [kotadb](appendices/examples/kotadb)
- [overstory](appendices/examples/overstory)
- [pi-mono](appendices/examples/pi-mono)
