...
- **To [Evaluation](../8-practices/2-evaluation.md)**: Patterns require evaluation to verify effectiveness. Self-improving experts need measurement to validate that improvement is happening.
