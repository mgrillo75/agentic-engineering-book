...
- **To [Foundations](../1-foundations/_index.md):** The four pillars framework (prompts, models, context, tools) is itself a mental model for decomposing agentic systems
- **To [Patterns](../7-patterns/_index.md):** Patterns are mental models made concrete through implementation—abstract frameworks translated into specific architectural decisions
